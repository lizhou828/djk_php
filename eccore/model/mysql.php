...
class cls_mysql
{
    ...
    //设置自动提交事务
    function auto_commit_true()
    {
        mysql_query("SET AUTOCOMMIT=1");
    }

    //设置不自动提交事务
    function auto_commit_flase()
    {
    ...
    function query($sql, $type = '', $times=0)
    {
        ...
        /*
         $makeLog=@fopen(ROOT_PATH."/temp/logs/runing_".date("Y")."-".date("m")."-".date("d").".log","a");
         @fwrite($makeLog,"执行sql=".$sql."\n\n");
         @fclose($makeLog);*/
    ...
    function ErrorMsg($message = '', $sql = '')
    {
        ...
        else
        {
            ...
            echo Lang::get('mysql_error_report');
        }
