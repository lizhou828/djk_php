...
class DefaultPassportUser extends BasePassportUser
{
    ...
    /* 注册 */
    function register($user_name, $password, $email,$invitation_code, $local_data = array(),$member_type)
    {
        ...
        $local_data['invitation_code']= $invitation_code;
        $local_data['reg_time']     = gmtime();
		$local_data['member_type']     = $member_type;
        /* 添加到用户系统 */
