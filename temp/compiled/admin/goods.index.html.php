    ...
    <div class="fontl">
      ...
      <div class="left">
          ...
          <select class="querySelect" name='if_show'>
              ...
              <option value="1"  <?php if ($_GET['if_show'] == 1): ?>  selected="selected"<?php endif; ?> >上架</option>
              <option value="0" <?php if ($_GET['if_show'] == "0"): ?>  selected="selected"<?php endif; ?>>下架</option>
          </select>
          <select class="querySelect" name="closed">
              <option value="" selected="selected">--请选择--</option>
              <option value="1" <?php if ($_GET['closed'] == 1): ?>  selected="selected" <?php endif; ?>>禁售</option>
              <option value="0"  <?php if ($_GET['closed'] == "0"): ?>  selected="selected" <?php endif; ?>>正常</option>
          </select>
...
?>
        ...
        <tr class="tatr2">
            ...
            <td>
                <a target="_blank" href="<?php echo $this->_var['site_url']; ?>/index.php?app=goods&amp;id=<?php echo $this->_var['goods']['goods_id']; ?>">查看</a>
                <a href="javascript:get_price('<?php echo $this->_var['goods']['goods_id']; ?>')">价格</a>
                <div style="position: absolute;margin-top: 12px; display: none;right: 0px;border: 1px solid #ddd;padding: 5px;margin-left: 5px; background: #fff;z-index: 999" id="price_<?php echo $this->_var['goods']['goods_id']; ?>">
